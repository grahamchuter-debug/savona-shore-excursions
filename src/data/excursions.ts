...
export const excursions: ExcursionPage[] = [
  {
    ...
    whyWeChose: {
      lead: 'Genoa is the Riviera’s great maritime city — and from Savona it is close enough to experience properly without turning the day into a dash.',
      whyRecommended: 'If you want depth rather than a single postcard harbour, Genoa rewards the hours. Palazzi, harbour light and the caruggi give you Liguria’s urban story in one carefully paced call.',
      whoItSuits: 'Curious first-time visitors, architecture lovers and travellers who prefer a real city day over a scenic drive alone.',
      whatMakesItSpecial: 'You feel the weight of a trading republic that shaped the Mediterranean — then still have time for focaccia and a calm return.',
      cruiseFit: 'Road time is usually shorter and more predictable than the Portofino coast, which makes the return buffer easier to protect on a full day in port.',
      theExperience: 'You leave with a sense of Genoa’s character — not a checklist of façades photographed through a window.',
    },
  ...
  },
  {
    ...
    cruiseSuitability: "Best with 8+ hours in port",
    whyWeChose: {
      lead: 'This is the Riviera day most cruise passengers picture before they step ashore — and the one we still recommend when the ship hours allow it.',
      whyRecommended: 'Portofino and Santa Margherita deliver the colour, harbour atmosphere and Ligurian light that define this coast. Done well, it feels unhurried rather than snatched.',
      whoItSuits: 'First-time Riviera visitors with a long call who want the classic harbour day and are happy to travel for it.',
      whatMakesItSpecial: 'Two complementary moods: Santa Margherita’s promenade ease and Portofino’s famous horseshoe harbour — sequenced around your all-aboard.',
      cruiseFit: 'The day only works with disciplined timing. We choose operators and routing that treat the ship clock as non-negotiable.',
      theExperience: 'You return with the Riviera’s most recognisable images — and the quieter satisfaction of having been back in good time.',
    },
    supplier: SEG_SUPPLIER,
  },
  {
    ...
    whyWeChose: {
      lead: 'Not every perfect Riviera day is a single famous name. Sometimes the better memory is a wider sense of Liguria.',
      whyRecommended: 'When you want coastal beauty without forcing everything through Portofino’s busiest corners, Discovery spreads the day across scenery, villages and breathing room.',
      whoItSuits: 'Travellers who value atmosphere and photography over ticking one iconic box — especially on a long call.',
      whatMakesItSpecial: 'The drive itself becomes part of the pleasure: cliff roads, changing light and stops chosen for the day rather than a rigid brochure.',
      cruiseFit: 'Flexible village mix lets the team protect the return buffer when traffic or seasonal access shifts.',
      theExperience: 'You leave feeling you have tasted the Riviera’s character — not only visited its most photographed square.',
    },
    supplier: SEG_SUPPLIER,
  },
  {
    ...
    whyWeChose: {
      lead: 'Savona is often treated as a gateway only. That overlooks how good a short, well-guided morning by the terminal can be.',
      whyRecommended: 'When hours are limited — or you simply prefer not to spend the day in a vehicle — this is the highest-confidence way to enjoy Liguria without transfer risk.',
      whoItSuits: 'Short calls, families, guests with limited mobility preferences, and anyone who wants flavour and context close to the ship.',
      whatMakesItSpecial: 'Priamar, old-town lanes and local tastes sit minutes from the terminal. You get place and pace without the long road.',
      cruiseFit: 'Minimal transfer distance means the generous return buffer is built in by geography, not hope.',
      theExperience: 'You step back aboard having properly arrived in Liguria — grounded, oriented and unhurried.',
    },
    supplier: SEG_SUPPLIER,
  },
  {
    ...
    whyWeChose: {
      lead: 'Some of Liguria’s most lovable harbours are not the ones printed largest on the map.',
      whyRecommended: 'For guests who want colour, sea air and village texture without the densest Portofino crowds, this coastal day feels generous and human-scaled.',
      whoItSuits: 'Small-group travellers, photographers and return visitors who have already seen Portofino — or prefer a calmer alternative.',
      whatMakesItSpecial: 'Painted harbour houses, working waterfronts and a lunch window that still respects the ship.',
      cruiseFit: 'Scenic routing with fewer bottleneck pressures than the most famous promontory approaches, when timed correctly.',
      theExperience: 'You remember Liguria as lived-in beauty — laundry lines, harbour boats and light on coloured plaster — not only a celebrity pier.',
    },
    supplier: SEG_SUPPLIER,
  },
];
