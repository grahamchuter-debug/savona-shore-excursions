...
export const metadata = buildMetadata({
  ...
  path,
  image: image.src,
  imageAlt: "Italian Riviera coastline — future Signature Experience from Savona cruise port",
  keywords: [
    "Signature Riviera Discovery",
    "Savona shore excursions",
    "small group Portofino tour",
...
const breadcrumbs = [
  { name: "Home", path: "/" },
  { name: "Signature Riviera Discovery", path },
];
        ...
        <div className="container-wide max-w-4xl">
          ...
          <div className="placeholder-widget mt-8">
            ...
            <p className="mt-3 text-gray-700 leading-relaxed">
              ...
              guests, cruise-timed routing and a carefully paced Italian Riviera day. It is a
          ...
          <div className="mt-12">
            <FAQSection faqs={signatureRivieraExperience.faqs} title="Signature Riviera Discovery — FAQs" />
          </div>
