...
export const metadata = buildMetadata({
  title: "Savona Cruise Ship Schedules",
  description:
    "Savona cruise ship schedules by year and month. See which ships call before booking Genoa, Portofino or city excursions.",
  path,
  keywords: ["Savona cruise ship schedule", "Savona cruise calendar", "Savona ship schedule"],
});
...
export default function ShipSchedulesPage() {
  return (
    <>
      <JsonLd data={[breadcrumbSchema(breadcrumbs), webPageSchema({ title: "Savona Cruise Ship Schedules", description: "Savona cruise ship schedules by year and month.", path })]} />
      <PageHero title="Savona Cruise Ship Schedules" subtitle="See which ships are in port before you book Italian Riviera excursions. Times and berths are indicative — always confirm with your cruise line." compact />
