...
const description =
  "The complete Savona cruise port guide — terminal layout, walking routes, taxis, old town access and return-to-ship timing.";
...
export const metadata = buildMetadata({
  ...
  image: image.src,
  imageAlt: image.alt,
  keywords: ["Savona cruise port", "Savona cruise terminal", "Savona port to old town", "Savona cruise port guide"],
});

const breadcrumbs = [
  { name: "Home", path: "/" },
  { name: "Savona Cruise Port Guide", path },
];
    ...
    <>
      ...
      <section className="section-padding">
        <div className="container-wide max-w-4xl">
          ...
          <div className="mt-12">
            <FAQSection faqs={portGuideFaqs} title="Savona port FAQs" />
          </div>
