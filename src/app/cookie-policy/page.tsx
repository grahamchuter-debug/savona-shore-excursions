...
export const metadata = buildMetadata({
  title: "Cookie Policy",
  description: `Cookie policy for ${SITE.name} — how we use cookies and similar technologies on savonashoreexcursions.com.`,
  path,
  noindex: true,
});
        ...
        <div className="container-wide max-w-3xl">
          ...
          <div className="mt-6 space-y-4 text-gray-700 leading-relaxed">
            <p>
              ...
              remember preferences and understand how visitors use our Savona and Italian Riviera planning guides.
            </p>
            <p>
