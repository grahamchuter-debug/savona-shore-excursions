...
const path = "/guides";
const description =
  "Italian Riviera cruise planning guides from Savona — Genoa, Portofino, Santa Margherita, Savona Old Town and practical port-day advice.";

export const metadata = buildMetadata({
  title: "Italian Riviera Cruise Planning Guides from Savona",
  description,
  path,
  keywords: [
    "Savona cruise port guide",
    "Portofino from Savona",
    "Savona shore excursions guide",
    "Genoa from Savona",
    "Italian Riviera cruise guide",
  ],
});
    ...
    <>
      <JsonLd
        data={[
          ...
          webPageSchema({ title: "Italian Riviera Cruise Planning Guides from Savona", description, path }),
        ]}
      />
      <PageHero
        title="Italian Riviera Cruise Planning Guides"
        subtitle="Your gateway to Liguria — Genoa, Portofino, Santa Margherita, Savona Old Town and practical advice for every type of cruise passenger."
      ...
      <section className="section-padding">
        <div className="container-wide">
          ...
          <p className="section-subtitle">Practical guides to Ligurian highlights with transfer times and return-to-ship advice.</p>
