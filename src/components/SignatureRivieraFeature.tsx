    ...
    <div className="card-signature grid gap-0 overflow-hidden lg:grid-cols-2">
      ...
      <div className="flex flex-col justify-center p-8 sm:p-10 lg:p-12">
        ...
        <p className="mt-4 text-sm leading-relaxed text-gray-700">
          {comingSoon
            ? "Our flagship Signature Experience is in development — a curated small-group Riviera day that will become the primary recommendation on this site. The homepage is designed so this slot becomes your first choice without a redesign."
            : "The experience we would honestly recommend to a first-time cruise passenger who wants the very best of the Italian Riviera in a single port day."}
        </p>
        ...
        {comingSoon ? (
          <div className="placeholder-widget mt-6 text-left">
            ...
            <p className="mt-2 text-sm text-gray-600">
              Portofino-area harbours, quieter Ligurian villages, photography stops and a local lunch
