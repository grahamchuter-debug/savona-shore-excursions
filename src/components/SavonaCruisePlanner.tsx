...
export function SavonaCruisePlanner() {
  ...
  const [interests, setInterests] = useState<string[]>(["savona", "portofino"]);
  ...
  function downloadPdf() {
    ...
    doc.save("savona-cruise-plan.pdf");
  }
  ...
  return (
    <div className="card-feature">
      ...
      <div className="mt-6 flex flex-wrap gap-3">
        <button type="button" onClick={generate} className="btn-primary">Build my Savona plan</button>
      ...
      {plan && (
        <div className="mt-8 space-y-8">
          ...
          <p className="text-xs text-gray-500">Guidance is indicative — always confirm your ship&apos;s all-aboard time and build a 60–90 minute return buffer. Traffic on the A10 and coastal roads toward Genoa and Portofino can lengthen journey times.</p>
        </div>
      )}
    </div>
  );
