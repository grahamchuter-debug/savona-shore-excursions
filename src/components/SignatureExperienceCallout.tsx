...
const CONTEXT_COPY = {
  portofino: "Considering Portofino? Our future Signature Riviera Discovery is being designed as a carefully paced small-group coastal day.",
  savona: "Exploring Savona? Our future Wow Collection will add distinctive small-group Ligurian routes developed around cruise timings.",
  general: "Our future flagship Signature Riviera Discovery is a proposed small-group coastal experience. It is still in preparation.",
};
  ...
  if (compact) {
    return (
      <div className="card-signature mt-10">
        ...
        <h2 className="mt-4 font-display text-xl font-bold text-gray-900">{signatureRivieraExperience.title}</h2>
