...
export function HighlightArticle({ page }: { page: AttractionPage }) {
  ...
  return (
    <>
      ...
      />
      <PhotoHeroBand image={image} eyebrow="From Savona Cruise Port" title={page.title} subtitle={page.tagline} compact />
      ...
      <section className="section-padding">
        <div className="container-wide max-w-4xl">
          ...
          {(page.slug === "portofino-from-savona" || page.slug === "savona-old-town") && (
            <SignatureExperienceCallout
              context={page.slug === "portofino-from-savona" ? "portofino" : "savona"}
            />
          )}

          {related.length > 0 && (
            <div className="mt-12">
              <h2 className="section-title text-2xl mb-6">More Riviera guides</h2>
          ...
          <div className="mt-12">
            <FAQSection faqs={page.faqs} title={`${page.attractionName} from Savona — FAQs`} />
          </div>
          <div className="mt-12">
            <PlanningLinks />
          </div>
